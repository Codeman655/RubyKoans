...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer the former. It's simply more readible for me. It appears to
  # define an existing method within the class rather than appending 
  # a new class definition.
  # Are there times you might prefer one over the other?
  # If the class is highly modular (or is renamed often) the latter 
  # method would be simpler, maybe than having a class definition within
  # a class. Honestly, I'd still prefer the former
  # ------------------------------------------------------------------
