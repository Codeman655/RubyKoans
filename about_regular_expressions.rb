...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # They match against the largest string they can posssibly find.
  # given a match between ab and abb, "abb" will always be returned by a 
  # greedy operator
  ...
  # A character class matches against any grouping of the individual characters listed
  # in the class. Where as an alteration is a way to define multi-character strings, 
  # in the same way one defines characters in the character class. 
