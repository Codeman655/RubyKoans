...
class AboutBlocks < Neo::Koan
  ...
  #Bonus Question: What do lambda and yield do?
  #yield gives way to a block given in the function call. Lambda is a way to create an anonymous
  #function (block) and assign it to a variable.
  #
  #Bonus Question: What do the ampersands indicate
  #Not entirely sure. May be a reference to a block variable.
