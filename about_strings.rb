...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # CC> I suspect it has to deal with the fact that its modifying the original
    # object. The shovel operater also has the neat ability to combine objects
    # when it concatentates, which saves memory. The following test exemplifies that
    # fact:
    # 2.1.4 :001 > a = "alpha_"
    #  => "alpha_"
    # 2.1.4 :002 > a.object_id
    #  => 19839720
    # 2.1.4 :003 > b = a
    #  => "alpha_"
    ...
    # 2.1.4 :009 > a
    #  => "alpha_kappa"
    # 2.1.4 :010 > a.object_id
    #  => 19839720
    # 2.1.4 :011 > b.object_id
    #  => 19598280
    # 2.1.4 :012 > c.object_id
    #  => 19839720
    # 2.1.4 :013 >
  end
